...
FlowRouter.route('/dashboard', {
	...
	action(){
		BlazeLayout.render('dashboard', {content: 'staffProfile'});
	}
});
...
FlowRouter.route('/admin', {
	...
	triggersEnter: [checkLoggedIn],
	action(){
		BlazeLayout.render('dashboard', {content: 'admin'});
	}
});
...
FlowRouter.route('/message/view/:title', {
	name: 'singleMessage',
	action(){
...
FlowRouter.route('/message/edit', {
	name: 'editMessage',
	action(){
		BlazeLayout.render('dashboard', {content: 'editMessage'});
	}
});
...
FlowRouter.route('/feedback', {
	name: 'feebackList',
	action(){
		BlazeLayout.render('dashboard', {content: 'feebackList'});
	}
});
FlowRouter.route('/message/view/:title', {
	name: 'singleFeedback',
...
FlowRouter.route('/st/profile/edit', {
	name: 'editProfile',
	action(){
		BlazeLayout.render('stDashboard', {content: 'editProfile'});
	}
});
